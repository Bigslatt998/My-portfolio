...
<div className={Styles.SliderWrap} >  
            ...
            <div className={`${Styles.Myskills}`} style={{transform: `translateY(-${currentSlide * 180}px)`,
                    ...
                    {RecentDetails.map((Content) => (
                        ...
                        }} id={Content.id} className={`${Styles.Box} ${isLight? Styles.LightMood : ''}`}>{Content.Text}</div>
                    ))}
            </div>
            </div>
